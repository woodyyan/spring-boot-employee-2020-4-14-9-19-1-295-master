...
public class EmployeeControllerTest {
    ...
    public void setUp() {
        ...
        Employee employee0 = new Employee(0, 1, "Xiaoming", 20, "Male", 0, new ParkingBoy());
        Employee employee1 = new Employee(1, 1, "Xiaohong", 19, "Male", 0, new ParkingBoy());
        Employee employee2 = new Employee(2, 2, "Xiaozhi", 15, "Male", 0, new ParkingBoy());
        Employee employee3 = new Employee(3, 1, "Xiaogang", 16, "Male", 0, new ParkingBoy());
        Employee employee4 = new Employee(4, 1, "Xiaoxia", 15, "Male", 0, new ParkingBoy());
